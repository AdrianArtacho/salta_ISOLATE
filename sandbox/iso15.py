...
drawing = False
paused = False
video_paused = False  # New flag for pausing video capture and recording
frame_buffer = []
frame_number = 0
max_buffer_size = 30
...
while cap.isOpened():
    ...
    # Move the display frame update outside the video_paused check
    ...
    # Write to output only when not paused
